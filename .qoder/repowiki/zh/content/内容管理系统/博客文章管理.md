...
- [hexo-site/source/_posts/2026-04-08-interview-questions.md](file://hexo-site/source/_posts/2026-04-08-interview-questions.md)
- [hexo-site/source/_posts/2026-05-11-interview-crazygame.md](file://hexo-site/source/_posts/2026-05-11-interview-crazygame.md)
- [hexo-site/source/_posts/2026-05-11-interview-huanlehuyu.md](file://hexo-site/source/_posts/2026-05-11-interview-huanlehuyu.md)
...
## 更新摘要
**变更内容**
- 新增了三个重要的面试问答文章，涵盖性能测试、功能测试和客户端性能测试
- 更新了面试问题分类体系，新增"面试问题"分类
- 增强了性能测试相关内容，包括功耗分析、PerfDog使用、Unity Profiler等专业工具
- 扩展了测试用例设计和性能优化的专业知识
- 更新了文章模板和分类系统
...
## 简介
本文件面向不同技术水平的博客作者，系统讲解基于 Hexo 的博客文章管理，包括 Markdown + Front-matter 结构、文章模板配置、内容格式要求、分类与标签体系、发布流程与草稿管理、预览与测试方法、批量创建与管理技巧，以及常见问题与排错建议。内容结合当前仓库中的实际配置与示例文件，特别是新增的性能测试面试问答文章，帮助你高效、稳定地维护博客内容。
...
- **新增面试问题分类**
  - 新增"面试问题"分类，包含性能测试、功能测试、客户端性能测试等专题
  - 涵盖游戏测试岗位面试的核心知识点和实践经验
...
## 架构概览
下图展示了从 Hexo 文章文件到页面渲染的关键路径，包括 Front Matter 解析、模板渲染、主题装配与静态页面生成，以及新增的面试问题分类体系。
...
- **分类与标签的作用**
  - categories：用于文章的大类划分（如技术文档、学习笔记、面试问题）
  - tags：用于细粒度标记（如性能测试、Python、游戏开发、功能测试）
- **使用方式**
...
### 新增面试问答内容分析
**更新** 新增了三个重要的面试问答文章，涵盖游戏测试领域的核心知识点

- **游戏客户端性能测试面试题整理**
  - 涵盖功耗分析、PerfDog使用、测试用例设计、引擎测试、卡顿定位、内存泄漏等核心知识点
  - 包含384行详细内容，是目前最长的技术文章
  - 涉及三角洲、崩坏星穹铁道、和平精英等游戏的实际测试案例
  - 详细介绍了Unity Profiler、RenderDoc等专业工具的使用方法

- **游戏功能测试面试题整理（疯狂游戏）**
  - 涵盖适配性拷问、过往经历深挖、功能测试专业提问、游戏理解与品类适配、综合素养与职业规划等核心模块
  - 包含231行详细内容，涉及《香肠派对》和《咸鱼之王》等游戏测试经验
  - 详细说明了手游黑盒功能测试的完整流程和测试用例设计方法

- **客户端性能测试面试记录（欢乐互娱）**
  - 涵盖渲染优化、LOD分级测试、RenderDoc截帧分析、Unity Profiler函数耗时分析、Memory Profiler内存分析等核心模块
  - 包含170行详细内容，涉及静态合批、动态合批、实例化等渲染优化技术
  - 详细介绍了LOD分级测试的具体实施步骤和分析方法
...
## 结论
通过 Hexo 的 Markdown + Front-matter 结构、标准化的脚手架模板、清晰的分类与标签体系，以及完善的本地预览与部署机制，本博客能够稳定、高效地管理各类文章内容。新增的面试问答文章丰富了博客的内容生态，特别是游戏测试领域的专业知识。建议在写作流程中严格执行草稿—预览—构建—部署的步骤，并利用 Hexo 的模板系统和 Butterfly 主题提升内容组织与展示效果。
...
- **实际示例**
  ...
  - 面试问答：[2026-04-08-interview-questions.md](file://hexo-site/source/_posts/2026-04-08-interview-questions.md)
  - 功能测试：[2026-05-11-interview-crazygame.md](file://hexo-site/source/_posts/2026-05-11-interview-crazygame.md)
  - 客户端性能测试：[2026-05-11-interview-huanlehuyu.md](file://hexo-site/source/_posts/2026-05-11-interview-huanlehuyu.md)
- **配置文件**
...
- **本地开发**
  ...
  - 部署命令：`npm run deploy`
- **新增面试问题分类**
  - 面试问题分类：包含性能测试、功能测试、客户端性能测试等专题
  - 标签系统：性能测试、面试、游戏测试、Unity等专业标签
  - 内容深度：涵盖从基础概念到高级工具使用的完整知识体系